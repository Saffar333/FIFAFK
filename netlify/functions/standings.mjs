// Netlify Function (v2): serves /api/standings
// Pulls live FIFA World Cup 2026 data from ESPN server-side (no key, no CORS),
// maps it to the 16 drafted teams and derives stage / group-winner / status.
...
const STG  = { r32: 1, r16: 2, qf: 3, sf: 4, final: 5 };
const NEXT = { r32: 2, r16: 3, qf: 4, sf: 5, final: 6 };
...
export function derive(standings, scoreboard) {
